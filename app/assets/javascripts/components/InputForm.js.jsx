...
var RetailerList = React.createClass({
  ...
  //      index = index;
  //      return city.toLowerCase() === retailer.city.toLowerCase();
 ...
 //     retailerZip: React.PropTypes.string
 //   },
 //   render:function() {
 //     return(
 //      <div>
 //        <table>
 //         <tr>
 //           <td> {this.props.retailerName}</td>
 //           <td> {this.props.retailerAddress}</td>
 //           <td> {this.props.retailerCity}</td>
 //           <td> {this.props.retailerState}</td>
 //           <td> {this.props.retailerZipCode}</td>
 //         </tr>
 //       </table>
 //     </div>
 //    );
